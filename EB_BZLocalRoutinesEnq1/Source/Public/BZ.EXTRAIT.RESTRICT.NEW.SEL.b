...
$PACKAGE EB.BZLocalRoutinesEnq1
    SUBROUTINE BZ.EXTRAIT.RESTRICT.NEW.SEL(ENQ.DATA)
$USING EB.API
...
* $INSERT I_F.BZ.COFFRE.LOYER - Not Used anymore;    F.COMPTE=''
   ...
   * CONVERT VM TO FM IN YFT.AdhocChargeRequests.AcChargeRequest.ChgRecordStatusCHANGE @VM TO @FM IN Y.SELECTION

    LOCATEFT.AdhocChargeRequests.AcChargeRequest.ChgRecordStatus IN Y.SELECTION SETTING ACC.POS THEN
...
*ZIT-UPG-R09-R13/E
   ...
   * CONVERT VM TO FM IN Y.SELECTION
    ...
    LOCATE "SELECT.ACCOUNT" IN Y.SELECTION SETTING ACC.POS THEN
