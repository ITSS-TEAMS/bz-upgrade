...
$PACKAGE EB.BZLocalRoutinesEnq1
    SUBROUTINE  BZ.ENQ.ECH.IJARA.CRT
$USING EB.API
...
*-----------------------------------------------------------------------------
    ...
    * $INSERT I_F.BZ.COFFRE.LOYER - Not Used anymore;ITIONS
*ZIT-UPG-R09-R13 / S
...
*    CALL GET.LOC.REF("LD.LOANS.AND.DEPOSITS","SEC.DEP.AMFT.AdhocChargeRequests.AcChargeRequest.ChgRecordStatus
*    CALL GET.LOC.REF("LD.LOANS.AND.DEPOSITS"FT.AdhocChargeRequests.AcChargeRequest.ChgRecordStatus*    CALL GET.LOC.REF("LD.LOANS.AND.DEPOSITS","REF.CRT.PRV",N.PRV)
...
*    CALL GET.LOC.REF("LD.LOANS.AND.DEPOSITS","SUS.TVA.CRT",N.SUS.TVA.CRT)
    ...
    * ZIT-UPG-R13-R19/E 
    ...
    FN.EB.DataAccess.OpfB.DataAccess.OpfMMISSION.TYPE = 'F.FT.COMMISSION.TYPE'
    F.FT.COMMISSION.TYPE = ''
    K.FT.COMMISSION.TYPE = ''
    R.FT.COMMISSION.TYPE = ''
    E.FT.COMMISSION.TYPE = ''

    FN.LD.LOANS.AND.DEFT.AdhocChargeRequests.AcChargeRequest.ChgRelatedRefLOANS.AND.DEPOSITS'
    F.LD.EB.DataAccess.FReadAND.DEPOSITS = ''
    K.LD.LOANS.AND.DEPOSITS = O.DATA
    R.LD.LOANS.AND.DEPOSITS = ''
    E.LD.LOANS.AND.DEPOSITS = ''

    FN.CUSTOMER = 'F.CUSTOEB.BZLocalTable1.BzCoffreLoyer.BzCoffreLoyerRefLoyerEB.SystemTables.setE('')
    K.CUSTOMER = ''
    R.CUSTOMER = ''EB.BZLocalTable1.BzCoffreLoyer.BzCoffreLoyerRefLoyer''

    FN.PROVISOIEB.DataAccess.FWrite.BZ.IJR.CRT.PROVISOIRE'
    F.PROVISOIRE = ''
    R.PROVISOIRE = ''
    E.PREB.SystemTables.setAf()*-----------------------------------------------------------------------------
* <Rating>-6</Rating>
*-----------------------------------------------------------------------------
$PACKAGE EB.BZLocalRoutinesEnq1
    SUBROUTINE  BZ.ENQ.ECH.IJARA.CRT
...
*    CALL GET.LOC.REF("LD.LOANS.AND.DEPOSITS","SUS.TVA.CRT",N.SUS.TVA.CRT)
    ...
    * ZIT-UPG-R13-R19/E 
    ...
    F.PROVISOIRE = ''
    R.PROVISOIRE = ''
    E.PROVIFT.AdhocChargeRequests.AcChargeRequest.ChgRelatedRef   CAEB.SystemTables.setE()*-----------------------------------------------------------------------------
* <Rating>-6</Rating>
*-----------------------------------------------------------------------------
$PACKAGE EB.BZLocalRoutinesEnq1
    SUBROUTINE  BZ.ENQ.ECH.IJARA.CRT
