...
$PACKAGE EB.BZLocalRoutinesEnq1
    SUBROUTINE NOFILE.EDITIQUE.PMS(TABLEAU)
$USING EB.API
...
*ZIT-UPG-R13-R19 : GET.LOC.REF converted to MULTI.GET.LOC.REF & Removed hard code in F.READ.
*-----------------------------------------------------------------------------
...
** $INSERT I_COMMON - Not Used anymore;IQUE.SYNC
* $INSERT I_EQUATE - Not Used anymore;.PMS.RET.SOURCE
...
*-------EB.SystemTables.getVFunction()-------------EB.SystemTables.getVFunction()------------EB.SystemTables.getRNew()-FT.AdhocChargeRequests.AcChargeRequest.ChgRecordStatus-*
    ...
    F.MFT.AdhocChargeRequests.AcChargeRequest.ChgRecordStatusC=''
    ERR.MM=''
    ...
    FN.CUS = "F.CUSTOMER"
    F.CUS = ""
    CUS.REB.DataAccess.Opf''
    ERR.CEB.DataAccess.Opf''
    ...
    FNFT.AdhocChargeRequests.AcChargeRequest.ChgRelatedRefs.FReadF.EDITIQUE.SYNC"
    F.SYNC = ""

    FN.LUP="F.EB.LOOKUP"
    F.LUP=""

    FN.CURREEB.BZLocalTable1.BzCoffreLoyer.BzCoffreLoyerRefLoyertE("F.CURRENCY")
    F.CURRENCY=""

    FN.SECT = "F.SEB.BZLocalTable1.BzCoffreLoyer.BzCoffreLoyerRefLoyer = ""
EB.DataAccess.FWriteT.REC=''
    ERR.SECT=''

    POUREB.SystemTables.setAf()*-----------------------------------------------------------------------------
* <Rating>179</Rating>
*-----------------------------------------------------------------------------
$PACKAGE EB.BZLocalRoutinesEnq1
    SUBROUTINE NOFILE.EDITIQUE.PMS(TABLEAU)
...
*----------------------------------------------------------------------------*
    ...
    POURCENFT.AdhocChargeRequests.AcChargeRequest.ChgRelatedRef R.EB.SystemTables.setE('')
    R.NEW(ED.PMS.TYPE)=''
...
*ZIT-UPG-R13-R19 E  
    ...
    IF Y.LIB.NAT.CLT EQ 'PM' THEN
        ...
        Y.NUM.IDENTITE=CUS.REC<EB.CUS.LEGAL.ID><1,2>
         Y.LUP.ID = ''
		 Y.LUP.ID = "CUS.LEGAL.DOC.NAME*":Y.TYPE.NUM.IDENT
      *  CALL F.READ(FN.LUP,"CUS.LEGAL.DOC.NAME*":Y.TYPE.NUM.IDENT, REC.LUP,F.LUP, ERR.LUP)
	  CALL F.READ(FN.LUP,Y.LUP.ID,REC.LUP,F.LUP,ERR.LUP)
    ...
    END ELSE
        ...
        IF Y.LIB.NAT.CLT EQ 'PP' THEN
            ...
            Y.NUM.IDENTITE=CUS.REC<EB.CUS.LEGAL.ID><1,1>
                Y.LUPID = ''
				Y.LUPID = "CUS.LEGAL.DOC.NAME*":Y.TYPE.NUM.IDENT
        *    CALL F.READ(FN.LUP,"CUS.LEGAL.DOC.NAME*":Y.TYPE.NUM.IDENT, REC.LUP,F.LUP, ERR.LUP)
			 CALL F.READ(FN.LUP,Y.LUPID, REC.LUP,F.LUP, ERR.LUP)
            Y.TYPE.NUM.IDENT.LIB=REC.LUP<EB.LU.DESCRIPTION>
