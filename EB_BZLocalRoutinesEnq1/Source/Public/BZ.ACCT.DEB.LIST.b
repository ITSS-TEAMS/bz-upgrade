...
*ZIT-UPG-R13-R19: COMMENTED F.READ AS R.USER CONTAINS CURRENT USER
*-----------------------------------------------------------------------------
$PACKAGE EB.BZLocalRoutinesEnq1
    SUBROUTINE BZ.ACCT.DEB.LIST(ENQ.DATA)
$USING EB.API
...
*    CALL F.READ (FN.USER,OPERATOR,R.USER,F.USER,ERR1) ;*NOT NEEDED 
