...
$PACKAGE EB.BZLocalRoutinesEnq1
    SUBROUTINE  BZ.ENQ.ECH.IJARA.CTI
$USING EB.API
...
*ZIT-UPG-R13-R19 : REPLACED GET.LOC.REF TO MULTI.GET.LOC.REF			  
*-----------------------------------------------------------------------------
...
********EB.SystemTables.getVFunction()*//    CALL GET.LOC.REF("LD.LOANS.AND.DEPFT.AdhocChargeRequests.AcChargeRequest.ChgRecordStatusMT",N.LD.ACOMPTE)
*//    CALL GET.LOC.REF("LDFT.AdhocChargeRequests.AcChargeRequest.ChgRecordStatusTS","TIEG",N.TIEG)
...
*ZIT-UPG-R13-R19: S
    ...
    YFIELD.NAME ="SEC.DEP.AMT":@VM:"TIEG":@VM:"REF.CRT.PRV":@VM:"PRM.TAKAFUL":@VM:"SUS.TVA.CLT":@VM:"SUS.TVA.CRT"
    LREF.POS = ''
    CALL MULTI.GET.LOC.REF(YAPPLICATION.NAME, YFIELD.NAME, LREF.POS)
    N.LD.ACOMPTE = LREF.POS<1, 1>
    N.TIEG = LREF.POS<1, 2>
    N.PRV = LREF.POS<1, 3>
	N.PRM.TAKAFUL = LREF.POS<1, 4>
	N.SUS.TVA.CLT = LREF.POS<1, 5>
	N.SUS.TVA.CRT = LREF.POS<1, 6>
*ZIT-UPG-R13-R19: E
    ...
    K.TIMEB.DataAccess.Opf = '130'
    K.REGEB.DataAccess.OpfHEANCE = '137'
    K.TVA.REG.ECHEANCE = '995'

    FN.FT.COMMISSION.TYPE = 'F.FT.COMMISSION.TYPE'
    F.FT.COMMISSION.TYPE = ''
    K.FT.COMMISSIOEB.SystemTables.getRNew()EFT.AdhocChargeRequests.AcChargeRequest.ChgRelatedRef.COMMISSION.TYPE = ''
    E.FT.EB.DataAccess.FReadSION.TYPE = ''

    FN.LD.LOANS.AND.DEPOSITS = 'F.LD.LOANS.AND.DEPOSITS'
    F.LD.LOANS.AND.DEPOSITS = ''
    K.LD.LOANS.AND.DEPOSITS EB.BZLocalTable1.BzCoffreLoyer.BzCoffreLoyerRefLoyer.LOANS.AND.DEPOSITS = ''
    E.LD.LOAEB.SystemTables.setE('')

    FN.CUSTOMER = 'FEB.BZLocalTable1.BzCoffreLoyer.BzCoffreLoyerRefLoyerCUSTOMER = ''
    K.CUSTOMER = EB.DataAccess.FWrite R.CUSTOMER = ''
    E.CUSTOMER = ''
...
*ZIT-UPG-R13-R19: E
    ...
    FN.PROVFT.AdhocChargeRequests.AcChargeRequest.ChgRelatedRefIJR.CRT.PROVISOIRE'
