...
$PACKAGE EB.BZLocalRoutinesEnq1
    SUBROUTINE ZIT.CEC.BUILD.OUTWARD.010
$USING EB.API
...
*    CMD = 'COMO ON ANAS.CEC'
*    EXEEB.SystemTables.getVFunction()*AA = '' ; OPEN "","TOOLS" TO F.TOOLS ELSFT.AdhocChargeRequests.AcChargeRequest.ChgRecordStatusUB.VALUE = 1

    GOSUB BUILD.OUTWARD

*  FT.AdhocChargeRequests.AcChargeRequest.ChgRecordStatus header in case for each missing transaction type in daily outward
