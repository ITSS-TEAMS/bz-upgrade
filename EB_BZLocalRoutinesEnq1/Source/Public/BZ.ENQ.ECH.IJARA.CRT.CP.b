...
$PACKAGE EB.BZLocalRoutinesEnq1
    SUBROUTINE  BZ.ENQ.ECH.IJARA.CRT.CP
$USING EB.API
...
*ZIT-UPG-R13-R19-GET.LOC.REF TO MULTI.GET.LOC.REF;COMMENTED DEBUG
*				-INITIALISED F.READ VARIABLES
*-----------------------------------------------------------------------------
...
********EB.SystemTables.getVFunction()   CALL BZ.GET.TVA.COLLECTE(Y.TAX.TAUX,Y.FT.AdhocChargeRequests.AcChargeRequest.ChgRecordStatus  Y.TAX.TAUX = Y.TAX.TAUX/100
**************FT.AdhocChargeRequests.AcChargeRequest.ChgRecordStatus S 
 ...
 *   CALL GET.LOC.REF("LD.LOANS.AND.DEPOSITS","PRM.TAKAFUL",N.PRM.TAKAFUL)
 *   CALL GET.LOC.REF("LD.LOANS.AND.DEPOSITS","SUS.TVA.CLT",N.SUS.TVA.CLT)
 *   CALL GET.LOC.REF("LD.LOANS.AND.DEPOSITS","SUS.TVA.CRT",N.SUS.TVA.CRT)

		Y.APP='LD.LOANS.AND.DEPOSITS'
		Y.FIELD='SEC.DEP.AMT':@VM:'TIEG':@VM:'REF.CRT.PRV':@VM:'PRM.TAKAFUL':@VM:'SUS.TVA.CLT':@VM:'SUS.TVA.CRT'
		Y.POS=''
		CALL MULTI.GET.LOC.REF(Y.APP,Y.FIELD,Y.POS)
		N.LD.ACOMPTE=Y.POS<1,1>
		N.TIEG=Y.POS<1,2>
		N.PRV=Y.POS<1,3>
		N.PRM.TAKAFUL=Y.POS<1,4>
		N.SUS.TVA.CLT=Y.POS<1,5>
		N.SUS.TVA.CRT=Y.POS<1,6>
*ZIT-UPG-R13-R19 E 		
    ...
    K.TIMBRE = '130'
    K.REGEB.DataAccess.OpfHEANCE = '137'
    K.TVAEB.DataAccess.OpfG.ECHEANCE = '995'

    FN.FT.COMMISSION.TYPE = 'F.FT.COMMISSION.TYPE'
    F.FT.COMMISSION.TYPE = ''
    K.FT.COMMISSION.TYPE = ''
    R.FT.COMMISSIOEB.SystemTables.getRNew()EFT.AdhocChargeRequests.AcChargeRequest.ChgRelatedRef.COMMISSION.TYPE = ''

    FN.EB.DataAccess.FReadNS.AND.DEPOSITS = 'F.LD.LOANS.AND.DEPOSITS'
    F.LD.LOANS.AND.DEPOSITS = ''
    K.LD.LOANS.AND.DEPOSITS = "LD1332900005"
    R.LD.LOANS.AND.DEPOSITS EB.BZLocalTable1.BzCoffreLoyer.BzCoffreLoyerRefLoyerNS.AND.DEPOSITS = ''

    FN.CUSEB.SystemTables.setE('F.CUSTOMER')
    F.CUSTOMER = ''EB.BZLocalTable1.BzCoffreLoyer.BzCoffreLoyerRefLoyer''
    R.CUSTOMER = EB.DataAccess.FWrite E.CUSTOMER = ''

    FN.PROVISOIRE = 'F.BZ.IJR.CRT.PROVISOIRE'
    F.PREB.SystemTables.setAf()*-----------------------------------------------------------------------------
* <Rating>-6</Rating>
*-----------------------------------------------------------------------------
$PACKAGE EB.BZLocalRoutinesEnq1
    SUBROUTINE  BZ.ENQ.ECH.IJARA.CRT.CP
...
*ZIT-UPG-R13-R19 E 		
    ...
    FN.PROVISOIRE = 'F.BZ.IJR.CRT.PROVISOIRE'
    F.PROVIFT.AdhocChargeRequests.AcChargeRequest.ChgRelatedRef R.PREB.SystemTables.setE('')
    E.PROVISOIRE = ''
...
*PRIME.TKL = R.PROVISOIRE<IJR.PRIME.TAKAFUL>
    PRIME.TKL = R.LD.LOANS.AND.DEPOSITS<LD.LOCAL.REF,N.PRM.TAKAFUL>

*SUSP.TVA.CLT = R.PROVISOIRE<IJR.SUSP.TVA.CLIENT>
    SUSP.TVA.CLT = R.LD.LOANS.AND.DEPOSITS<LD.LOCAL.REF,N.SUS.TVA.CLT>

*SUSP.TVA.CRT = R.PROVISOIRE<IJR.SUSP.TVA.CONTRAT>
    SUSP.TVA.CRT = R.LD.LOANS.AND.DEPOSITS<LD.LOCAL.REF,N.SUS.TVA.CRT>
    ...
    CALL F.READ(FN.LMM.ACCOUNT.BALANCES,ID,R.LM,F.LMM.ACCOUNT.BALANCES,LM.ERR1)
