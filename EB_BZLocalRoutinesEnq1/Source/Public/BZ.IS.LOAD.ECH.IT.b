...
*   CALL GET.LOC.REF("LD.LOANS.AND.DEPOSITS","TIEG",N.TIEG)
        ...
        YEB.DataFT.AdhocChargeRequests.AcChargeRequest.ChgRelatedRefON.NAME = 'LD.LOANS.AND.DEPOSITS'
        YFIELD.NAME ="SEC.DEP.AMT":@VM:"TIEG"
        LREF.POS = ''
        CALL MULTI.GET.LOC.REF(YAPPLICATION.NAME, YFIELD.NAME, LREF.POS)
        N.LD.ACOMPTE = LREF.EB.BZLocalTable1.BzCoffreLoyer.BzCoffreLoyerRefLoyer N.TIEG       = LREF.POS<1, 2>
    
   
 EB.SystemTables.setE(R.LDEB.BZLocalTable1.BzCoffreLoyer.BzCoffreLoyerRefLoyerS<LD.EB.SystemTables.getIdNew()RY>)
        ACOMPTE = 0
