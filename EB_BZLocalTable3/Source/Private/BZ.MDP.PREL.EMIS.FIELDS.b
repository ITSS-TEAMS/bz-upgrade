* @ValidationCode : MjoyNTgwOTEyMTc6Q3AxMjUyOjE2MDA1NjIxOTI5NjU6QWRtaW5pc3RyYXRldXI6LTE6LTE6MDoxOnRydWU6Ti9BOlIyMF9TUDQuMDotMTotMQ==
...
SUBROUTINE BZ.MDP.PREL.EMIS.FIELDS
*-----------------------------------------------------------------------------
*<doc>
...
*-----------------------------------------------------------------------------
    ...
    EB.Template.TableAddfielddefinition("RIB.PAYEUR", "35","A","")
...
*******************specifique
    ...
    EB.Template.TableAddfielddefinition("CPT.TECHNIQUE", "20","A","")

*******************RESERVED
    EB.Template.TableAddfielddefinition("REJET.MAN", "3","":@FM:"YES_NO","")
    EB.Template.TableAddfielddefinition("REF.REPRIS", "70","A","")
