* @ValidationCode : MjotNTY5Mjg5MzcyOkNwMTI1MjoxNjAwNTYyMTkzMDI5OkFkbWluaXN0cmF0ZXVyOi0xOi0xOjA6MTp0cnVlOk4vQTpSMjBfU1A0LjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 20 Sep 2020 01:36:33
...
SUBROUTINE BZ.MDP.PREL.EMIS.GLOB.FIELDS
*-----------------------------------------------------------------------------
*<doc>
...
*-----------------------------------------------------------------------------
    ...
    EB.Template.TableAddfielddefinition("REF.SUPPORT", "20","A","")
    EB.Template.TableAddfielddefinition("NOMBRE.PREL", "10","","")
    EB.Template.TableAddfielddefinition("MONTANT", "35","A","")
    EB.Template.TableAddfielddefinition("NOMBRE.DOM", "35","A","")
...
*******************specifique
    ...
    EB.Template.TableAddfielddefinition("COMPTE.CREANCIER", "10","A","")
    ...
    EB.Template.TableAddfielddefinition("FT.LIQUIDATION", "16","A","")
    EB.Template.TableAddfielddefinition("FICHIER.RECU", "65","A","")
    EB.Template.TableAddfielddefinition("REF.GLOBAL", "45","A","")
    ...
    EB.Template.TableAddfielddefinition("CPT.TECHNIQUE", "15","A","")

*******************RESERVED
    EB.Template.TableAddfielddefinition("DATE.PRES", "8","D","")

    EB.Template.TableAddfielddefinition("FICHIER.RETOUR", "40","A","")
