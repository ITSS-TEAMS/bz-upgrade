* @ValidationCode : MjotMTAwMDcyNDI0MjpDcDEyNTI6MTYwMDU2Mjc1MjM4NDpBZG1pbmlzdHJhdGV1cjotMTotMTowOjE6dHJ1ZTpOL0E6UjIwX1NQNC4wOi0xOi0x
...
SUBROUTINE BZ.MDP.REGISTRE.CHQ.DRAFT.FIELDS
*-----------------------------------------------------------------------------
*<doc>
...
*CALL Field.setCheckFile("BZ.MDP.REMISE.CHQ")
    ...
    EB.Template.TableAddfielddefinition("REF.CLE","25","A","")

    EB.Template.TableAddfielddefinition("ID.REGISTRE","20","A","")

    EB.Template.TableAddfielddefinition("DATE.ENVOI.REG","8", "D", "")
