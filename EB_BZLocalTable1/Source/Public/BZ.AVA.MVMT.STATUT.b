* @ValidationCode : MjoxMDEyMzYyMjc3OkNwMTI1MjoxNjAwNDc4OTM5NzAyOkFkbWluaXN0cmF0ZXVyOi0xOi0xOjA6MTpmYWxzZTpOL0E6UjE5X0FNUi4wOi0xOi0x
...
* $INSERT I_Table - Not Used anymore;
    ...
    $USING EB.Template
*-----------------------------------------------------------------------------
    EB.Template.setTableName('BZ.AVA.MVMT.STATUT')
    EB.Template.setTableTitle('BZ.AVA.MVMT.STATUT')
    ...
    EB.Template.setTableEquateprefix('MVT.STT')
*-----------------------------------------------------------------------------
