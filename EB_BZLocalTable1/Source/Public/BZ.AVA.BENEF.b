* @ValidationCode : MjoyOTgxMTMzODg6Q3AxMjUyOjE2MDA0Nzg5MzQyOTc6QWRtaW5pc3RyYXRldXI6LTE6LTE6MDoxOmZhbHNlOk4vQTpSMThfQU1SLjA6LTE6LTE=
...
* $INSERT I_Table - Not Used anymore;
    ...
    $USING EB.Template
*-----------------------------------------------------------------------------
    EB.Template.setTableName('BZ.AVA.BENEF')
    EB.Template.setTableTitle('BZ.AVA.BENEF')
    ...
    EB.Template.setTableEquateprefix('AVA.BEN')
*-----------------------------------------------------------------------------
