* @ValidationCode : MjoxMjIwMzU3OTcxOkNwMTI1MjoxNjAwNDc4OTg3MjQ2OkFkbWluaXN0cmF0ZXVyOi0xOi0xOjA6MTp0cnVlOk4vQTpSMTlfQU1SLjA6LTE6LTE=
...
SUBROUTINE BZ.COMPTE.GELE.SOLDE.FIELDS
*-----------------------------------------------------------------------------
*<doc>
...
*-----------------------------------------------------------------------------
    EB.Template.TableAddfielddefinition("COMPTE.SOLDE", "10","A","")
    EB.Template.FieldSetcheckfile('ACCOUNT')
    EB.Template.TableAddfielddefinition("REF.FT", "12","A","")
**RESERVED
