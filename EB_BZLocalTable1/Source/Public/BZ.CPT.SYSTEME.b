* @ValidationCode : Mjo1NjkwNjcxMzk6Q3AxMjUyOjE2MDA0Nzg5OTkzNzA6QWRtaW5pc3RyYXRldXI6LTE6LTE6MDoxOmZhbHNlOk4vQTpSMThfQU1SLjA6LTE6LTE=
...
* $INSERT I_Table - Not Used anymore;
    ...
    $USING EB.Template
*-----------------------------------------------------------------------------
    EB.Template.setTableName('BZ.CPT.SYSTEME')
    EB.Template.setTableTitle('BZ.CPT.SYSTEME')
    ...
    EB.Template.setTableEquateprefix('SYS')
*-----------------------------------------------------------------------------
