* @ValidationCode : MjotMTYzODU2NTMyMjpDcDEyNTI6MTYwMDQ3OTAyNzM3NzpBZG1pbmlzdHJhdGV1cjotMTotMTowOjE6dHJ1ZTpOL0E6UjE5X0FNUi4wOi0xOi0x
...
SUBROUTINE BZ.DECLARATION.EMPLOYEUR.FIELDS
...
*-----------------------------------------------------------------------------
    ...
    EB.Template.TableAddfielddefinition("STATUT", "8","":@FM : "GENERER_PREPARER","")
    EB.Template.TableAddfielddefinition("COMPTE", "12","A","")
    EB.Template.FieldSetcheckfile('ACCOUNT')

**RESERVED
    EB.Template.TableAddfielddefinition("ANNEXE", "1","":@FM : "2_3_4_5","")
