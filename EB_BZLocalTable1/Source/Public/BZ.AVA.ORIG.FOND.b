* @ValidationCode : MjozNzYxMjA0OTI6Q3AxMjUyOjE2MDA0Nzg5NDAwOTc6QWRtaW5pc3RyYXRldXI6LTE6LTE6MDoxOmZhbHNlOk4vQTpSMTlfQU1SLjA6LTE6LTE=
...
* $INSERT I_Table - Not Used anymore;
    ...
    $USING EB.Template
*-----------------------------------------------------------------------------
    EB.Template.setTableName('BZ.AVA.ORIG.FOND')
    EB.Template.setTableTitle('BZ.AVA.ORIG.FOND')
    ...
    EB.Template.setTableEquateprefix('ORI.FON')
*-----------------------------------------------------------------------------
