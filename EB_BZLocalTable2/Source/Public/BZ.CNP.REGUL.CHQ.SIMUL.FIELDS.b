* @ValidationCode : MjoxNDQxNjU1OTEyOkNwMTI1MjoxNjAwNDg0NzE4ODAxOkFkbWluaXN0cmF0ZXVyOi0xOi0xOjA6MTp0cnVlOk4vQTpSMjBfU1A0LjA6LTE6LTE=
...
SUBROUTINE BZ.CNP.REGUL.CHQ.SIMUL.FIELDS
*----------------------------------------------------------------------------
*<doc>
...
*-----------------------------------------------------------------------------
    EB.Template.TableDefineid("ID", "" : @FM : "35" : @FM : "A")   ;*changed
*RIB : NUM_CHEQUE
*-----------------------------------------------------------------------------
    VT.MOTIF="MOTIF.CNP"
...
*********************************
    ...
    EB.Template.TableAddfielddefinition("MNT.FRAIS.HUISS","15", "AMT", "")
    EB.Template.TableAddfielddefinition("MNT.COM.PREAVIS","15", "AMT", "")
    EB.Template.TableAddfielddefinition("MNT.COM.CNP","15", "AMT", "")
    EB.Template.TableAddfielddefinition("MNT.COM.REGUL","15", "AMT", "")

    EB.Template.TableAddfielddefinition("MONTANT.TOTAL","15", "AMT", "")
    EB.Template.TableAddfielddefinition("DATE.OPERATION","8", "D", "")

    EB.Template.TableAddfielddefinition("COMPTE","15", "A", "")
    EB.Template.TableAddfielddefinition("AGENCE","15", "A", "")
