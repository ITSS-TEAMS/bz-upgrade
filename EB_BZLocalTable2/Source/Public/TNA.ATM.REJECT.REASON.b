* @ValidationCode : MjoxODM0Mjk5NjczOkNwMTI1MjoxNjAwNTYwMTQxODU3OkFkbWluaXN0cmF0ZXVyOi0xOi0xOjA6MTpmYWxzZTpOL0E6UjIwX1NQNC4wOi0xOi0x
...
SUBROUTINE TNA.ATM.REJECT.REASON
*-----------------------------------------------------------------------------
*********************************************************************
*                      PROJET CHALLENGE 24
*********************************************************************
...
*** </region>
    ...
    EB.Template.setTableName('TNA.ATM.REJECT.REASON');* Full application name including product prefix
