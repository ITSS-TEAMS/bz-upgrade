* @ValidationCode : MjoxNDg2NjA3MjIzOkNwMTI1MjoxNjAwNTYwMTQyMjE4OkFkbWluaXN0cmF0ZXVyOi0xOi0xOjA6MTp0cnVlOk4vQTpSMjBfU1A0LjA6LTE6LTE=
...
SUBROUTINE TNA.CARD.BZ.RENOUV.GEN.FIELDS
...
*-----------------------------------------------------------------------------
    ...
    EB.Template.TableAddfielddefinition("TIME", "14","A","")
    EB.Template.TableAddfielddefinition("NOM.FICHIER", "35","A","")
    EB.Template.TableAddfielddefinition("NBR.CARTE", "5","A","")
    EB.Template.TableAddfielddefinition("STATUT", "1","":@FM : "Genere_Confirme","")
